...
"""Oracle ODBC (pyodbc) DB Adapter

$Id: odbcoracon.py 643 2010-03-30 15:01:34Z vmozhaev $
"""
...
def printableDbName():
    return getUtility(IDatabaseConfig).ORA_ODBC_DSN
...
class Connection(_odbccon.Connection):
    ...
    def __init__(self):
        c = pyodbc.connect(getUtility(IDatabaseConfig).ORA_ODBC_DSN)
        self.c = c
